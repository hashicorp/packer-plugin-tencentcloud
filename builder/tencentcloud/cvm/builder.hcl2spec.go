...
type FlatConfig struct {
	...
	EnhancedService           *FlatTencentCloudEnhancedService `mapstructure:"enhanced_service,omitempty" required:"false" cty:"enhanced_service" hcl:"enhanced_service"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"enhanced_service":             &hcldec.BlockSpec{TypeName: "enhanced_service", Nested: hcldec.ObjectSpec((*FlatTencentCloudEnhancedService)(nil).HCL2Spec())},
